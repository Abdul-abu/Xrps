...
h1{font-size:24px;margin-bottom:8px;text-shadow:var(--glow)}
...
<form method="post"><button class="reset" name="reset">RESET SCORE</button></form>
</div></div>
</body></html>